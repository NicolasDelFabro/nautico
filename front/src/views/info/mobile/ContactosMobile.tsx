...
const ContactosMobile = () => {
  return (
    <div className="flex justify-center items-center w-full py-10 px-4">
      <div className="flex flex-col w-full bg-shadow/20 rounded-2xl overflow-hidden">
        {/* INFORMACIÓN */}
        <section className="flex flex-col justify-center px-8 py-10">
          ...
          <div className="flex flex-col gap-4 mt-6 text-base font-regular">
        ...
        {/* MAPA */}
        <section className="flex justify-center items-center px-6 pb-8">
          <div className="w-full h-[280px] p-1 bg-secundary rounded-2xl overflow-hidden">
            <MapClub />
          </div>
        </section>
      </div>
...
export default ContactosMobile;