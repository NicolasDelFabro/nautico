...
const BENEFICIOS = [
  {
    icon: FaDumbbell,
    title: "FUERZA",
    text: "Desarrollá tu fuerza funcional de manera efectiva.",
  },
  {
    icon: FaRunning,
    title: "RESISTENCIA",
    text: "Mejorá tu capacidad física y cardiovascular.",
  },
  {
    icon: FaHeartbeat,
    title: "BIENESTAR",
    text: "Sentite mejor por dentro y por fuera.",
  },
  {
    icon: FaUsers,
    title: "COMUNIDAD",
    text: "Entrená en un ambiente motivador y positivo.",
  },
];

const BULLETS = [
  "Ejercicios variados y dinámicos",
  "Adaptado a todos los niveles",
  "Mejora tu rendimiento diario",
  "Clases grupales motivadoras",
];
      ...
      <section className="relative h-[560px] overflow-hidden">
        ...
        <div className="relative z-20 flex h-full flex-col justify-end px-6 pb-16">
          ...
          <p className="mt-4 text-base leading-7 text-primary-text">
            Entrenamientos dinámicos y completos para mejorar tu fuerza,
            resistencia y calidad de vida.
          </p>
      ...
      <section className="flex flex-col bg-background py-10 px-6">
        ...
        <div className="flex flex-col items-start gap-4 mt-8">
          ...
          <p className="text-primary-text text-sm leading-6">
            El entrenamiento funcional trabaja movimientos naturales del
            cuerpo para mejorar tu condición física general.
          </p>
